...
public class ContractValuedItem extends BackboneElement {
	 ...
	 * @return Specific type of Contract Valued Item that may be priced.
	 */
	public CodeableConcept getEntityCodeableConcept() { return entityCodeableConcept; }

	/**
	 * Setter for entityCodeableConcept
	 * @param value Specific type of Contract Valued Item that may be priced.
	 */
	 ...
	 * @return Identifies a Contract Valued Item instance.
	 */
	public Identifier getIdentifier() { return identifier; }

	/**
	 * Setter for identifier
	 * @param value Identifies a Contract Valued Item instance.
	 */
	...
	/**
	 * Getter for quantity
	 * @return Specifies the units by which the Contract Valued Item is measured or counted, and quantifies the countable or measurable Contract Valued Item instances.
	 */
	public Quantity getQuantity() { return quantity; }

	/**
	 * Setter for quantity
	 * @param value Specifies the units by which the Contract Valued Item is measured or counted, and quantifies the countable or measurable Contract Valued Item instances.
	 */
	 ...
	 * @return A Contract Valued Item unit valuation measure.
	 */
	public Money getUnitPrice() { return unitPrice; }

	/**
	 * Setter for unitPrice
	 * @param value A Contract Valued Item unit valuation measure.
	 */
	...
	/**
	 * Getter for net
	 * @return Expresses the product of the Contract Valued Item unitQuantity and the unitPriceAmt. For example, the formula: unit Quantity * unit Price (Cost per Point) * factor Number  * points = net Amount. Quantity, factor and points are assumed to be 1 if not supplied.
	 */
	public Money getNet() { return net; }

	/**
	 * Setter for net
	 * @param value Expresses the product of the Contract Valued Item unitQuantity and the unitPriceAmt. For example, the formula: unit Quantity * unit Price (Cost per Point) * factor Number  * points = net Amount. Quantity, factor and points are assumed to be 1 if not supplied.
	 */
