...
public class ClaimDetail extends BackboneElement {
	...
	@Expose
	private ArrayList<ClaimSubDetail> subDetail;

	/**
	 * Getter for subDetail
	 * @return Third tier of goods and services.
	 */
	public ArrayList<ClaimSubDetail> getSubDetail() { return subDetail; }

	/**
	 * Setter for subDetail
	 * @param value Third tier of goods and services.
	 */
	public void setSubDetail(ArrayList<ClaimSubDetail> value) { subDetail = value; }
