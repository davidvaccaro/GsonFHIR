...
public class ConsentActor extends BackboneElement {
	...
	/**
	 * Getter for role
	 * @return How the individual is involved in the resources content that is described in the consent.
	 */
	public CodeableConcept getRole() { return role; }

	/**
	 * Setter for role
	 * @param value How the individual is involved in the resources content that is described in the consent.
	 */
