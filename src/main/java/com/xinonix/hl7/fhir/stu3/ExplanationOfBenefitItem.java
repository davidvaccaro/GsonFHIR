...
public class ExplanationOfBenefitItem extends BackboneElement {
	...
	@Expose
	private ArrayList<ExplanationOfBenefitDetail> detail;

	/**
	 * Getter for detail
	 * @return Second tier of goods and services.
	 */
	public ArrayList<ExplanationOfBenefitDetail> getDetail() { return detail; }

	/**
	 * Setter for detail
	 * @param value Second tier of goods and services.
	 */
	public void setDetail(ArrayList<ExplanationOfBenefitDetail> value) { detail = value; }
