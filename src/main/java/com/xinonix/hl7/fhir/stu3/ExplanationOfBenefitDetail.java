...
public class ExplanationOfBenefitDetail extends BackboneElement {
	...
	/**
	 * Getter for type
	 * @return The type of product or service.
	 */
	public CodeableConcept getType() { return type; }

	/**
	 * Setter for type
	 * @param value The type of product or service.
	 */
	...
	/**
	 * Getter for service
	 * @return If this is an actual service or product line, ie. not a Group, then use code to indicate the Professional Service or Product supplied (eg. CTP, HCPCS,USCLS,ICD10, NCPDP,DIN,ACHI,CCI). If a grouping item then use a group code to indicate the type of thing being grouped eg. 'glasses' or 'compound'.
	 */
	public CodeableConcept getService() { return service; }

	/**
	 * Setter for service
	 * @param value If this is an actual service or product line, ie. not a Group, then use code to indicate the Professional Service or Product supplied (eg. CTP, HCPCS,USCLS,ICD10, NCPDP,DIN,ACHI,CCI). If a grouping item then use a group code to indicate the type of thing being grouped eg. 'glasses' or 'compound'.
	 */
	...
	@Expose
	private ArrayList<ExplanationOfBenefitSubDetail> subDetail;

	/**
	 * Getter for subDetail
	 * @return Third tier of goods and services.
	 */
	public ArrayList<ExplanationOfBenefitSubDetail> getSubDetail() { return subDetail; }

	/**
	 * Setter for subDetail
	 * @param value Third tier of goods and services.
	 */
	public void setSubDetail(ArrayList<ExplanationOfBenefitSubDetail> value) { subDetail = value; }
