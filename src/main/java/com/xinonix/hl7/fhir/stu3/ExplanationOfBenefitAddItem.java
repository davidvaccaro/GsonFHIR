...
public class ExplanationOfBenefitAddItem extends BackboneElement {
	...
	@Expose
	private ArrayList<ExplanationOfBenefitDetail1> detail;

	/**
	 * Getter for detail
	 * @return The second tier service adjudications for payor added services.
	 */
	public ArrayList<ExplanationOfBenefitDetail1> getDetail() { return detail; }

	/**
	 * Setter for detail
	 * @param value The second tier service adjudications for payor added services.
	 */
	public void setDetail(ArrayList<ExplanationOfBenefitDetail1> value) { detail = value; }
