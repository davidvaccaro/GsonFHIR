...
public class EligibilityResponseBenefitBalance extends BackboneElement {
	...
	@Expose
	private ArrayList<EligibilityResponseFinancial> financial;

	/**
	 * Getter for financial
	 * @return Benefits Used to date.
	 */
	public ArrayList<EligibilityResponseFinancial> getFinancial() { return financial; }

	/**
	 * Setter for financial
	 * @param value Benefits Used to date.
	 */
	public void setFinancial(ArrayList<EligibilityResponseFinancial> value) { financial = value; }
