...
public class MeasureReportPopulation1 extends BackboneElement {
	...
	/**
	 * Getter for patients
	 * @return This element refers to a List of patient level MeasureReport resources, one for each patient in this population in this stratum.
	 */
	public Reference getPatients() { return patients; }

	/**
	 * Setter for patients
	 * @param value This element refers to a List of patient level MeasureReport resources, one for each patient in this population in this stratum.
	 */
